...
import 'package:task_manager/shared/lib/drag_and_drop_lists_0.3.3/drag_and_drop_builder_parameters.dart';
import 'package:task_manager/shared/lib/drag_and_drop_lists_0.3.3/drag_and_drop_item.dart';
import 'package:task_manager/shared/lib/drag_and_drop_lists_0.3.3/drag_and_drop_item_target.dart';
import 'package:task_manager/shared/lib/drag_and_drop_lists_0.3.3/drag_and_drop_list_interface.dart';
import 'package:task_manager/shared/lib/drag_and_drop_lists_0.3.3/drag_and_drop_list_target.dart';
import 'package:task_manager/shared/lib/drag_and_drop_lists_0.3.3/drag_and_drop_list_wrapper.dart';
import 'package:task_manager/shared/lib/drag_and_drop_lists_0.3.3/drag_handle.dart';
    ...
    if (scrollController != null && pointerYPosition != null) {
      if (pointerYPosition < (top + _scrollAreaSize) &&
        ...
        final overDrag = max<double>(
          pointerYPosition - (bottom - _scrollAreaSize),
          _overDragMax,
        );
        newOffset = min(
          scrollController.position.maxScrollExtent,
