                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () => bloc.onTapToDragAndDrop(
                                  bloc.listBoardSubject.value[index]?.title ??
                                      '',
                                ),
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        bloc.listBoardSubject.value[index]
                                                ?.title ??
                                            '',
                            ...
                            separatorBuilder: (context, index) =>
                                const SizedBox(),
                            itemCount: bloc.listBoardSubject.value.length,
                          ),
                        ),
                      ],
                    ),
        ...
        floatingActionButton: ObsBuilder(
          ...
          builder: (context) {
            return SpeedDial(
              ...
              label: bloc.extendSubject.value
                  ? const Text('Open')
                  : null, // The label of the main button.
              activeLabel:
                  bloc.extendSubject.value ? const Text('Close') : null,
