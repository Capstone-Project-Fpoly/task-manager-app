...
class AddCardDateTimePicker extends ConsumerWidget {
  const AddCardDateTimePicker({Key? key,}) : super(key: key);
    ...
    return  ObsBuilder(
      ...
      builder: (context)
      {
        return  Row(
          ...
          children: [
            const Icon(Icons.access_time,color: ColorConstants.secondaryText,size: 28,),
            ...
            Column(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Text(
                    bloc.timeStartSubject.value == null?'Ngày Bắt Đầu...':'Ngày Bắt Đầu: ${bloc.timeStartSubject.value}',
                ...
                InkWell(
                  ...
                  child: Text(
                    bloc.timeFinishSubject.value == null?'Ngày hết hạn...':'Ngày hết hạn: ${bloc.timeFinishSubject.value}',
                    style: const AppTextStyle.black(
                      fontSize: 14,
