          ...
          return LoadingOverlay(
            ...
            child: SafeArea(
              ...
              appBar: AppBar(
                ...
                actions:  [
                  InkWell(
                    enableFeedback: bloc.isSubmitSubject.value&&bloc.isSubmitListSubject.value,
                    onTap: () {
                      bloc.onTapAddCard();
                    },
                    child: Icon(
                      ...
                      children: [
                        ...
                        PopupMenuButton<Fragment$BoardFragment?>(
                          ...
                          itemBuilder: (BuildContext context) =>
                              bloc.listBoardSubject.value.map((Fragment$BoardFragment? item) {
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(bloc.selectedBoardSubject.value?.title ?? 'Bạn chưa tạo bảng nào',
                                  style: const AppTextStyle.black(
                                    fontWeight: FontWeight.w600,
                                  ),),
                                const SizedBox(
                        ...
                        PopupMenuButton<Fragment$ListFragment?>(
                          onSelected: (Fragment$ListFragment? result) {
                            ...
                            bloc.selectedTextListSubject.value = result?.label??'';
                          },
                          itemBuilder: (BuildContext context) =>
                              bloc.listListSubject.value.map((Fragment$ListFragment? item) {
                          ...
                          child: Container(
                            padding: EdgeInsetsConstants.right20 +EdgeInsetsConstants.left8 +EdgeInsetsConstants.vertical8,
                            child:Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text(
                                  bloc.selectedTextListSubject.value??'Đang tải...',
                                ),
                                const SizedBox(
                                  width: 5,
                                  child: Icon(Icons.arrow_drop_down,color: ColorConstants.darkColor,),
                                ),
                              ],
                            ),
                          ),
                    ...
                    child: Container(
                      ...
                      child:Column(
                        ...
                        children: [
                            ...
                            mainAxisSize: MainAxisSize.min,
                              children: [
                                ...
                                PopupMenuButton<Fragment$UserFragment?>(
                                  ...
                                  child: const Icon(Icons.add,color: ColorConstants.white,size: 15,),
                                ),
                                ),
                                SizedBoxConstants.w12,
                                SizedBox(
                                  ...
                                  child:ListView.builder(
                                    ...
                                    itemCount: bloc.listSelectedMemberSubject.value.length,
                                    itemBuilder: (BuildContext context, int index) {
                                      bloc.selectedMemberSubject.value = bloc.listSelectedMemberSubject.value[index];
                                      return AppCircleAvatar(
                                        url: bloc.selectedMemberSubject.value?.avatar??'',
                                        width: 40,
                                        height: 40,
                                      );
                                    },
                          ...
                          Row(
                            children: [
                              const Icon(Icons.attach_file_outlined,color: ColorConstants.secondaryText,size: 28,),
                              SizedBoxConstants.w12,
                              InkWell(
                                onTap: (){
                                  //
