...
class BoardDetailAppBarEditListLabel extends StatelessWidget
    implements PreferredSizeWidget {
  const BoardDetailAppBarEditListLabel(this.bloc, {Key? key}) : super(key: key);
        ...
        Padding(
          ...
          child: ObsBuilder(
            ...
            builder: (context) {
              ...
              return InkWell(
                onTap: bloc.onTapSubmitEditListLabel,
                child: const Icon(
                  Icons.check,
                  color: Colors.white,
                ),
